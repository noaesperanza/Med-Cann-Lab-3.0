...
export const getDefaultRouteByType = (type: UserType): string => {
  const routes = {
    ...
    // Paciente: entrada primária em Analytics & Evolução (UX)
    'paciente': '/app/clinica/paciente/dashboard?section=analytics',
    'admin': '/app/admin', // Operador sistêmico — DECISAO_SELADA_ROTAS_CANONICAS_V1
  }
